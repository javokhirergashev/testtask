...
<div class="container title">
    <div class="row align-items-center justify-content-center">
        <h2>Resume of <?=$model->fullname?></h2>
        <div class="w-100"></div>
        ...
        <div class="head row justify-content-around rounded">
            <div class="left-side">
                <div class="photo rounded-circle d-flex align-items-center justify-content-center">
                    <img src="<?=\app\models\StaticFunctions::getImage('candidates',$model->id,$model->images)?>" alt="" style="width: 50%">
                </div>
            </div>
            <div class="personal-info rounded">
                <div class="name info-cel"> <?=$model->fullname?></div>
                <div class="profession info-cel">Adress: <?=$model->address?></div>
