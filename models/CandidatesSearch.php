...
class CandidatesSearch extends Candidates
{
    ...
    public function rules()
    {
        return [
            [['id', 'status'], 'integer'],
            [['fullname', 'address', 'email', 'images', 'website_link', 'phone', 'school', 'university', 'degree', 'experience_title', 'company', 'from_year', 'to_year', 'skill_first', 'skill_second', 'skill_third', 'telegram_link', 'instagram_link', 'facebook_link', 'tweetter_link'], 'safe'],
        ];
    }
